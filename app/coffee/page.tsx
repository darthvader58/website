    ...
    <section className="fade">
      ...
      <ScrollReveal delay={150}>
        <div className="grid gap-6 mb-12">
          <div className="relative overflow-hidden rounded-xl border border-slate-700/80 bg-slate-950/35 p-8 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] transition-colors duration-300 hover:border-amber-500/60 light:border-slate-300 light:bg-white/70">
            ...
            <div className="relative">
              <h2 className="mb-4 flex items-center gap-2 text-2xl font-semibold text-slate-100">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center rounded-lg border border-amber-400/70 bg-amber-500/10 px-6 py-3 font-semibold text-amber-200 transition-colors duration-200 hover:border-amber-300 hover:bg-amber-500/20 hover:text-amber-100 light:border-amber-600/70 light:text-amber-800 light:hover:text-amber-900"
              >
                Buy Me a Coffee
              </a>
            </div>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-12">
        <ScrollReveal delay={250}>
          <div className="rounded-xl border border-slate-700/80 bg-slate-950/30 p-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.035)] transition-colors duration-300 hover:border-purple-500/60 light:border-slate-300 light:bg-white/70">
