      ...
      <div className="grid md:grid-cols-2 gap-6">
        {competencies.map((comp, index) => (
          <ScrollReveal key={index} delay={200 + index * 100}>
            <Link href={comp.link} className="block group">
              <div className="border border-slate-800 rounded-lg p-6 hover:border-purple-700/50 hover:scale-105 transition-all duration-300 bg-slate-950/30 h-full">
